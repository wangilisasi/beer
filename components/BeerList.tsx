...
import type { Beer } from "../src/generated/prisma"; // Adjust the import path as necessary
                ...
                <div className="flex justify-between items-start relative">
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <button
                        className="text-red-500 hover:text-red-700 p-1 absolute -right-1 transition-opacity duration-200 sm:invisible sm:group-hover:visible"
                      >
